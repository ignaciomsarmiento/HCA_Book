...
01-importar-limpiar_datos_redcap.Rmd
02-importar-limpiar_datos_almacen.Rmd
03-unir_datos_redcap_almacen.Rmd

Estos se ordenarán y organizarán fácilmente en tu carpeta nuevo-proyecto/codigo/, ya que los números al principio ayudan a organizarlos (mantener el 0 al principio de los números del 0 al 9 ayuda mucho en la ordenación cuando tienes más de 10 archivos).

También es útil numerar y nombrar claramente tus archivos de datos. Estos generalmente deben corresponder a los archivos de código que los crearon. Al final de un paso de código, puedes guardar/escribir tu archivo de datos resultante en un archivo *.rda o un archivo *.csv, para ser cargado al inicio del siguiente archivo de código. Estos podrían verse así en la carpeta nuevo-proyecto/datos-procesados/:

01-datos_limpiados_redcap.csv
02-datos_limpiados_almacen.csv
...
Es sorprendentemente importante ser reflexivo sobre tu esquema de nombres segmentados desde el principio, ya que puede ayudarte de muchas maneras a organizar, ordenar y manipular archivos más adelante.
...
2018-04-26_ciencia-reproducible_diapositivas_leccion-01.pptx
